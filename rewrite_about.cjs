...
const aboutContent = `import { useState, useEffect } from 'react';
import { useLocation, Link } from 'react-router-dom';
import { getCMSGlobal, defaultAboutData } from '../../lib/cms';
import { motion } from 'motion/react';
import { Star, Lightbulb, Users, TrendingUp, Target, Download, ArrowRight, LayoutTemplate } from 'lucide-react';
...
fs.writeFileSync('src/pages/public/About.tsx', aboutContent);
