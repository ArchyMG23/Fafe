    ...
    >
      ...
      >
        <div className="flex items-center gap-3.5 min-w-0">
          {Icon && (
            <div className="w-9 h-9 rounded-xl bg-[#C8102E]/10 text-[#00843D] flex items-center justify-center shrink-0">
              <Icon className="w-5 h-5" />
            </div>
          )}
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h3 className="text-base font-bold text-[#063F3A] truncate">
                {title}
              </h3>
              {badge && (
                <span className="text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full bg-[#C8102E]/10 text-[#00843D]">
                  {badge}
                </span>
              )}
            </div>
