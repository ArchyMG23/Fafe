  ...
  if (!project) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#FAF9F6] text-center px-4">
        <h1 className="text-3xl font-bold font-heading text-[#063F3A] mb-4">Projet introuvable</h1>
        <p className="text-stone-600 mb-8">Ce contenu n'est pas disponible pour le moment.</p>
        <Link to="/projets-sociaux">
          <Button className="bg-[#C8102E] hover:bg-[#A30D25] text-white rounded-full">
  ...
  return (
    <div className="min-h-screen bg-[#FAF9F6] py-32">
      <div className="w-full max-w-7xl mx-auto px-4 md:px-6 max-w-4xl">
        <Link to="/projets-sociaux" className="inline-flex items-center text-[#00843D] hover:text-[#c96a1a] font-medium mb-8">
        ...
        <div className="prose prose-lg prose-stone max-w-none">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-[#063F3A]/5 mb-8">
            <h2 className="text-2xl font-bold font-heading text-[#063F3A] mb-4">Objectifs</h2>
          ...
          {project.impact && (
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-[#063F3A]/5">
              <h2 className="text-2xl font-bold font-heading text-[#063F3A] mb-4">Résultats attendus / obtenus</h2>
